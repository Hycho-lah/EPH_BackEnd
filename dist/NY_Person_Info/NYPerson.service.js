...
let NYPersonService = class NYPersonService {
    ...
    updateINYPerson(personId, newINYPerson) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (selectedINYPerson) {
                yield typeorm_1.getConnection().createQueryBuilder().update(NYPerson_entity_1.NYPersonEntity).set(newINYPerson)
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (selectedINYPerson) {
                yield typeorm_1.getConnection()
                    .createQueryBuilder()
                    .delete()
                    .from(NYPerson_entity_1.NYPersonEntity)
                    .where('id = :id', { id: personId })
                    .execute();
...
NYPersonService = __decorate([
    common_1.Injectable(),
    __param(0, common_1.Inject('NYPersonProvider')),
    __metadata("design:paramtypes", [typeorm_1.Repository])
], NYPersonService);
exports.NYPersonService = NYPersonService;
//# sourceMappingURL=NYPerson.service.js.map